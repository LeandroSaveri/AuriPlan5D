...
export function AIAssistant({ onClose, initialPrompt }: AIAssistantProps) {
  ...
  // Auto-generate when opened with a prompt from dashboard
  useEffect(() => {
    if (initialPrompt) {
      const timer = setTimeout(() => generate(initialPrompt), 300);
